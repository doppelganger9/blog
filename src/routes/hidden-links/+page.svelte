...
<p>Experiments and tools for Agile Meetings:</p>
<a href="/playground/au-hasard">Randomized List of Items (used in retrospectives or meetings)</a><br/>
<a href="/playground/md">Online Markdown editor/preview (used daily!)</a><br/>
<a href="/playground/poll">Safety Check poll (Alpha, sorry)</a><br/>
<a href="/playground/tab-counter">Timer displayed in a tab title (used daily!)</a><br/>

<p>Developper tools:</p>
