...
As you see, the idea is to have a **VisualStudio Code in the browser development environment** bootstraped from your repository.
...
Woops, If like me you are used to hit `CMD + W` on VSCode to close files, this will not work here, because it will close the browser tab! 😱
...
Don't forget to stop you workspaces, the free tier gives you 100 Hours which is really sufficient for my kind of usage: working on Github Repositories outside of working hours.

## This integration test is failing 🤭

After I finished writign the first draft of this post, I tried to `git push`, but I encountered this error:
```
...
- `git stash`-ed my uncommited changes,
...
- `git push` worked 🎉 from `master`, si I knew I would not have to copy all my changes out of Gitpod to my local computer,
